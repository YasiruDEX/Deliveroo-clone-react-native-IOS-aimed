import { Ancestor, Descendant, Element, ExtendedType, Location, Node, NodeEntry, Operation, Path, PathRef, Point, PointRef, Range, RangeRef, Span, Text, Transforms } from '../../../../packages/slate/src';
import { LeafEdge, MaximizeMode, RangeDirection, SelectionMode, TextDirection, TextUnit, TextUnitAdjustment } from '../../../../packages/slate/src/types/types';
import { OmitFirstArg } from '../../../../packages/slate/src/utils/types';
import { TextInsertFragmentOptions, TextInsertTextOptions } from '../../../../packages/slate/src/interfaces/transforms/text';
import { NodeInsertNodesOptions } from '../../../../packages/slate/src/interfaces/transforms/node';
/**
