// Internal Helpers
import type { $Dictionary } from 'i18next/typescript/helpers.js';
import type {
  DefaultNamespace,
  FlatNamespace,
  FormatFunction,
  ...
  ResourceLanguage,
  TOptions,
} from 'i18next/typescript/options.js';
import type { KeyPrefix, TFunction } from 'i18next/typescript/t.js';
...
export type * from 'i18next/typescript/options.js';
export type {
...
export type * from 'i18next/typescript/t.js';
export type {
  TFunction,
  ParseKeys,
  TFunctionReturn,
