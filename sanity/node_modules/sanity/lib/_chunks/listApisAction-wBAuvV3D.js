import { getClientUrl } from './_internal-ZiurxKnw.js';
async function listGraphQLApis(args, context) {
  ...
  endpoints.forEach((endpoint, index) => {
    ...
    const url = getClientUrl(client, "graphql/".concat(dataset, "/").concat(tag));
...
export { listGraphQLApis as default };
//# sourceMappingURL=listApisAction-wBAuvV3D.js.map
