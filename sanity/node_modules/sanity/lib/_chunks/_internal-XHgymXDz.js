...
async function getBuildAction() {
  const mod = await Promise.resolve().then(function () {
    return require('./buildAction-9n_jmdsE.js');
  });
  return mod.default;
}
const checkCommand = {
...
const deployCommand = {
  ...
  action: async (args, context) => {
    const mod = await Promise.resolve().then(function () {
      return require('./deployAction-Jw2aP2vp.js');
    });
...
const undeployCommand = {
  ...
  action: async (args, context) => {
    const mod = await Promise.resolve().then(function () {
      return require('./undeployAction-IxPUX005.js');
    });
    return mod.default(args, context);
  },
  helpText: helpText$n
...
const description = "Downloads and validates all document specified in a workspace (beta)".concat(chalk__default.default.cyan("*"), ".\n\n").concat(chalk__default.default.cyan("*"), "Note: As it's currently in beta, some features may not be fully stable.\nWe encourage users to report any issues encountered to help us improve.\nThank you for your understanding and support!\n\nhttps://github.com/sanity-io/sanity/issues/5510\n");
...
const validateDocumentsCommand = {
  ...
  action: async (args, context) => {
    const mod = await Promise.resolve().then(function () {
      return require('./validateAction-vVbalIO6.js');
    });
    return mod.default(args, context);
  }
};
...
async function getDevAction() {
  const mod = await Promise.resolve().then(function () {
    return require('./devAction-IULBl6a4.js');
  });
  return mod.default;
}
...
async function getPreviewAction$1() {
  const mod = await Promise.resolve().then(function () {
    return require('./previewAction-9qYTmt6f.js');
  });
  return mod.default;
}
...
const execCommand = {
  ...
  action: async (args, context) => {
    const mod = await Promise.resolve().then(function () {
      return require('./execScript-PnEoO24F.js');
    });
    return mod.default(args, context);
  }
};
...
const listGraphQLAPIsCommand = {
  ...
  action: async (args, context) => {
    const mod = await Promise.resolve().then(function () {
      return require('./listApisAction-Sy8lUBIf.js');
    });
    return mod.default(args, context);
  },
  helpText: helpText$4
...
const deployGraphQLAPICommand = {
  ...
  action: async (args, context) => {
    const mod = await Promise.resolve().then(function () {
      return require('./deployApiAction-BE-PNzrA.js');
    });
    return mod.default(args, context);
  },
  helpText: helpText$3
...
const deleteGraphQLAPICommand = {
  ...
  action: async (args, context) => {
    const mod = await Promise.resolve().then(function () {
      return require('./deleteApiAction-jsAT3gl8.js');
    });
    return mod.default(args, context);
  },
  helpText: helpText$2
...
//# sourceMappingURL=_internal-XHgymXDz.js.map
