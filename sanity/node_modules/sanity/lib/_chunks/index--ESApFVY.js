...
var structure = require('./structure-Vsl1B9Jz.js');
...
var Tooltip = require('./Tooltip-HN_as_Fj.js');
...
function PaneRouterProvider(props) {
  ...
  return /* @__PURE__ */jsxRuntime.jsx(structure.PaneRouterContext.Provider, {
    value: ctx,
    children
  });
}
...
function StructureError(_ref8) {
  ...
  const {
    t
  } = sanity.useTranslation(structure.structureLocaleNamespace);
  const stack = (cause == null ? void 0 : cause.stack) || error.stack;
  const showStack = stack && !(cause instanceof structure.SerializeError) && !error.message.includes("Module build failed:");
  const path = cause instanceof structure.SerializeError ? cause.path : [];
  const helpId = cause instanceof structure.SerializeError && cause.helpId || error.helpId;
    ...
    children: /* @__PURE__ */jsxRuntime.jsxs(ui.Container, {
      children: [/* @__PURE__ */jsxRuntime.jsx(ui.Heading, {
        ...
        children: [path.length > 0 && /* @__PURE__ */jsxRuntime.jsxs(ui.Stack, {
          ...
          marginTop: 4,
          children: /* @__PURE__ */jsxRuntime.jsx(Tooltip.Button, {
...
function UnknownPane(props) {
  ...
  return /* @__PURE__ */jsxRuntime.jsxs(structure.Pane, {
    id: paneKey,
    selected: isSelected,
    children: [/* @__PURE__ */jsxRuntime.jsx(structure.PaneHeader, {
      title: t("panes.unknown-pane-type.title")
    }), /* @__PURE__ */jsxRuntime.jsx(structure.PaneContent, {
...
const StructureToolPane = React.memo(function StructureToolPane2(props) {
  ...
  return /* @__PURE__ */jsxRuntime.jsx(PaneRouterProvider, {
    ...
    children: /* @__PURE__ */jsxRuntime.jsx(React.Suspense, {
      fallback: /* @__PURE__ */jsxRuntime.jsx(structure.LoadingPane, {
        paneKey,
        path,
        selected
      }),
...
var _a;
const StyledPaneLayout = styled__default.default(structure.PaneLayout)(_a || (_a = __template(["\n  min-height: 100%;\n  min-width: 320px;\n"])));
    ...
    children: [/* @__PURE__ */jsxRuntime.jsxs(StyledPaneLayout, {
      ...
      children: [paneDataItems.map(_ref12 => {
        ...
        return /* @__PURE__ */jsxRuntime.jsx(React.Fragment, {
          children: pane === structure.LOADING_PANE ? /* @__PURE__ */jsxRuntime.jsx(structure.LoadingPane, {
            paneKey,
            path,
            selected
        ...
        }, "".concat(pane === structure.LOADING_PANE ? "loading" : pane.type, "-").concat(paneIndex));
      }), paneDataItems.length <= 1 && isResolvingIntent && /* @__PURE__ */jsxRuntime.jsx(structure.LoadingPane, {
...
function StructureToolBoundary(_ref13) {
  ...
  return /* @__PURE__ */jsxRuntime.jsx(ui.ErrorBoundary, {
    ...
    children: /* @__PURE__ */jsxRuntime.jsx(sanity.SourceProvider, {
      ...
      children: /* @__PURE__ */jsxRuntime.jsxs(structure.StructureToolProvider, {
        defaultDocumentNode,
        structure: structure$1,
        children: [/* @__PURE__ */jsxRuntime.jsx(StructureTool, {
          onPaneChange: structure.setActivePanes
...
//# sourceMappingURL=index--ESApFVY.js.map
