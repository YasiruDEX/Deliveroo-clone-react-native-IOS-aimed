...
const ListPaneHeader = _ref => {
  ...
  return /* @__PURE__ */jsxRuntime.jsx(structure.PaneHeader, {
    actions: /* @__PURE__ */jsxRuntime.jsx(structure.PaneHeaderActions, {
      menuItems,
      menuItemGroups
    }),
    backButton: features.backButton && index > 0 && /* @__PURE__ */jsxRuntime.jsx(Tooltip.Button, {
...
function ListPaneContent(props) {
  ...
  const getI18nText = sanity.useGetI18nText(items == null ? void 0 : items.filter(item => item.type !== "divider"));
  ...
  const renderItem = React.useCallback((item, ctx) => {
    ...
    return /* @__PURE__ */jsxRuntime.jsx(structure.PaneItem, {
  ...
  return /* @__PURE__ */jsxRuntime.jsx(structure.PaneContent, {
...
function ListPane(props) {
  ...
  return /* @__PURE__ */jsxRuntime.jsxs(structure.Pane, {
    ...
    minWidth: 320,
    selected: isSelected,
    children: [structure._DEBUG, /* @__PURE__ */jsxRuntime.jsx(ListPaneHeader, {
      index,
      menuItems,
      menuItemGroups,
      title
...
//# sourceMappingURL=index-nHJUwkL3.js.map
