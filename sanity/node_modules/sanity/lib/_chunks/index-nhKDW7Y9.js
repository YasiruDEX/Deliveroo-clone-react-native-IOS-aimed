...
import { useMemo, useCallback, useState, useEffect, memo, lazy, Suspense, Fragment } from 'react';
import { Card, Container, Heading, Stack, Text, Code, Box, Flex, useToast, useTheme, PortalProvider, ErrorBoundary } from '@sanity/ui';
import { usePaneLayout, ChildLink, BackLink, ReferenceChildLink, ParameterizedLink, PaneRouterContext, useStructureTool, LOADING_PANE, structureLocaleNamespace, SerializeError, Pane, PaneHeader, PaneContent, LoadingPane, PaneLayout, setActivePanes, StructureToolProvider } from './structure-BXyPLY49.js';
...
import { isRecord, useDocumentStore, useTranslation, Translate, useEditState, useSchema, unstable_useValuePreview, _isCustomDocumentTypeDefinition, useWorkspace, SourceProvider } from 'sanity';
...
import { Button } from './Tooltip-lbAs9i17.js';
...
var _a$1;
const PathSegment = styled.span(_a$1 || (_a$1 = __template$1(["\n  &:not(:last-child)::after {\n    content: ' \u279D ';\n    opacity: 0.5;\n  }\n"])));
  ...
  return /* @__PURE__ */jsxs(Pane, {
    ...
    children: [/* @__PURE__ */jsx(PaneHeader, {
      ...
      children: /* @__PURE__ */jsx(Box, {
        padding: 4,
        children: typeof type === "string" ? /* @__PURE__ */jsx(Text, {
          as: "p",
          muted: true,
...
const paneMap = {
  component: lazy(() => import('./index-KR8OJFAC.js')),
  document: lazy(() => import('./pane-VF6Eo3pL.js')),
  documentList: lazy(() => import('./pane-q2Bucqcl.js')),
  list: lazy(() => import('./index-Q6vTglGv.js'))
};
const StructureToolPane = memo(function StructureToolPane2(props) {
  const {
    active,
    childItemId,
    groupIndex,
...
const StructureTool = memo(function StructureTool2(_ref11) {
  let {
    onPaneChange
  } = _ref11;
  var _a2;
      ...
      children: [paneDataItems.map(_ref12 => {
        ...
        return /* @__PURE__ */jsx(Fragment, {
          children: pane === LOADING_PANE ? /* @__PURE__ */jsx(LoadingPane, {
            ...
            path,
            selected
          }) : /* @__PURE__ */jsx(StructureToolPane, {
            active,
            groupIndex,
            index: paneIndex,
            pane,
...
function StructureToolBoundary(_ref13) {
  ...
  return /* @__PURE__ */jsx(ErrorBoundary, {
    ...
    children: /* @__PURE__ */jsx(SourceProvider, {
      ...
      children: /* @__PURE__ */jsxs(StructureToolProvider, {
        defaultDocumentNode,
        structure,
        children: [/* @__PURE__ */jsx(StructureTool, {
...
export { StructureToolBoundary as default };
//# sourceMappingURL=index-nhKDW7Y9.js.map
