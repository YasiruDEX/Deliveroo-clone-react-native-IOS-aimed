...
var _internalBrowser = require('./_chunks/_internalBrowser-93yjycLo.js');
...
var Tooltip = require('./_chunks/Tooltip-HN_as_Fj.js');
...
const ChangeFieldWrapper = props => {
  ...
  const {
    onSetFocus
  } = React__default.default.useContext(_internalBrowser.ConnectorContext);
  const [isHover, setHover] = React__default.default.useState(false);
  const onMouseEnter = React__default.default.useCallback(() => {
    setHover(true);
  }, []);
  const onMouseLeave = React__default.default.useCallback(() => {
    setHover(false);
  }, []);
  _internalBrowser.useReporter("change-".concat(PathUtils__namespace.toString(props.path)), () => ({
    element: ref.current,
    path: props.path,
    isChanged: true,
    hasFocus: false,
...
function useOnScroll(callback) {
  const parentContext = React__default.default.useContext(_internalBrowser.ScrollContext);
...
function getState(allReportedValues, hovered, byId, rootElement) {
  ...
  }).filter(_internalBrowser.isNonNullable).map(_ref4 => {
    let {
      field,
      change
    } = _ref4;
...
function ConnectorsOverlay(props) {
  ...
  const [hovered, setHovered] = React__default.default.useState(null);
  const allReportedValues = _internalBrowser.useReportedValues();
  ...
  return /* @__PURE__ */jsxRuntime.jsx(ScrollMonitor, {
    ...
    children: /* @__PURE__ */jsxRuntime.jsx(_internalBrowser.SvgWrapper, {
      style: {
...
function ConnectorGroup(props) {
  ...
  return /* @__PURE__ */jsxRuntime.jsxs(jsxRuntime.Fragment, {
    children: [/* @__PURE__ */jsxRuntime.jsx("g", {
      ...
      children: /* @__PURE__ */jsxRuntime.jsx(_internalBrowser.Connector, {
        from,
        to
      })
...
function EnabledChangeConnectorRoot(_ref6) {
  ...
  const [rootElement, setRootElement] = React__default.default.useState();
  const contextValue = React.useMemo(() => ({
    isReviewChangesOpen,
    onOpenReviewChanges,
    onSetFocus
  }), [isReviewChangesOpen, onOpenReviewChanges, onSetFocus]);
  return /* @__PURE__ */jsxRuntime.jsx(_internalBrowser.ConnectorContext.Provider, {
    value: contextValue,
    children: /* @__PURE__ */jsxRuntime.jsx(_internalBrowser.Tracker, {
      children: /* @__PURE__ */jsxRuntime.jsxs(_internalBrowser.ScrollContainer, {
        ...restProps,
        ref: setRootElement,
        className,
...
function DisabledChangeConnectorRoot(_ref7) {
  ...
  return /* @__PURE__ */jsxRuntime.jsx(_internalBrowser.ScrollContainer, {
    className,
    children
  });
}
...
function GetHookCollectionState(props) {
  ...
  return /* @__PURE__ */jsxRuntime.jsxs(jsxRuntime.Fragment, {
    children: [hooks.map(hook => {
      ...
      const key = keys[id] || 0;
      return /* @__PURE__ */jsxRuntime.jsx(_internalBrowser.HookStateContainer, {
        hook,
        id,
        args,
        onNext: handleNext,
...
function IntentButton(props) {
  return props.disabled ? /* @__PURE__ */jsxRuntime.jsx(Tooltip.Button, {
    ...props,
    as: "a",
    role: "link",
    "aria-disabled": "true"
  }) : /* @__PURE__ */jsxRuntime.jsx(Tooltip.Button, {
    ...props,
...
function createMockAuthStore(_ref10) {
  let {
    client,
    currentUser = null
  } = _ref10;
...
function useFormattedDuration(durationMs, options) {
  ...
  const locale = _internalBrowser.useCurrentLocale().id;
  const listFormat = _internalBrowser.useListFormat({
    type: "unit",
    style
  });
  ...
  const formatters = React.useMemo(() => ({
    days: _internalBrowser.intlCache.numberFormat(locale, {
      style: "unit",
      unit: "day",
      unitDisplay
    }),
    hours: _internalBrowser.intlCache.numberFormat(locale, {
      style: "unit",
      unit: "hour",
      unitDisplay
    }),
    minutes: _internalBrowser.intlCache.numberFormat(locale, {
      style: "unit",
      unit: "minute",
      unitDisplay
    }),
    seconds: _internalBrowser.intlCache.numberFormat(locale, {
      style: "unit",
      unit: "second",
      unitDisplay
    }),
...
function useNumberFormat() {
  ...
  const currentLocale = _internalBrowser.useCurrentLocale().id;
...
const ArrayOfOptionsFieldDiff = _ref11 => {
  let {
    diff,
    schemaType
  } = _ref11;
  ...
  const colorManager = _internalBrowser.useUserColorManager();
  const {
    t
  } = _internalBrowser.useTranslation();
  ...
  return /* @__PURE__ */jsxRuntime.jsx("div", {
    children: diff.items.map(item => normalizeItems(item, diff, schemaType)).filter(item => item !== null).sort(sortItems).map((item, index) => {
      ...
      const color = _internalBrowser.getAnnotationColor(colorManager, annotation);
      const action = isPresent ? t("changes.added-label") : t("changes.removed-label");
      return /* @__PURE__ */jsxRuntime.jsxs(ui.Flex, {
        align: "center",
        children: [/* @__PURE__ */jsxRuntime.jsx(_internalBrowser.DiffTooltip, {
          annotations: annotation ? [annotation] : [],
          description: action,
          children: /* @__PURE__ */jsxRuntime.jsxs(ui.Flex, {
            align: "center",
            children: [/* @__PURE__ */jsxRuntime.jsx(_internalBrowser.Checkbox, {
              checked: !isPresent,
              color
            }), /* @__PURE__ */jsxRuntime.jsx(ui.Box, {
              margin: 2,
              children: /* @__PURE__ */jsxRuntime.jsx(_internalBrowser.FromToArrow, {})
            }), /* @__PURE__ */jsxRuntime.jsx(_internalBrowser.Checkbox, {
              checked: isPresent,
              color
            })]
          })
...
function ItemPreview(_ref12) {
  ...
  return /* @__PURE__ */jsxRuntime.jsx(ui.Box, {
    marginX: 2,
    marginY: 1,
    children: typeof value === "string" || typeof value === "number" ? value : /* @__PURE__ */jsxRuntime.jsx(_internalBrowser.Preview, {
...
const UrlFieldDiff = _ref13 => {
  ...
  return /* @__PURE__ */jsxRuntime.jsx(_internalBrowser.DiffFromTo, {
    diff,
    schemaType,
    previewComponent: _internalBrowser.StringPreview
  });
};
const SlugFieldDiff = _ref14 => {
  let {
    diff,
    schemaType
  } = _ref14;
...
function HoveredFieldProvider(props) {
  ...
  return /* @__PURE__ */jsxRuntime.jsx(_internalBrowser.HoveredFieldContext.Provider, {
    value: context,
    children
  });
}
...
function FormBuilderProvider(props) {
  ...
  return /* @__PURE__ */jsxRuntime.jsx(_internalBrowser.FormBuilderContext.Provider, {
    value: formBuilder,
    children: /* @__PURE__ */jsxRuntime.jsx(_internalBrowser.FormCallbacksProvider, {
      onChange,
      onFieldGroupSelect,
      onPathBlur,
      onPathFocus,
      ...
      onSetPathCollapsed,
      onSetFieldSetCollapsed,
      children: /* @__PURE__ */jsxRuntime.jsx(_internalBrowser.DocumentIdProvider, {
        id,
        children: /* @__PURE__ */jsxRuntime.jsx(_internalBrowser.PresenceProvider, {
          presence,
          children: /* @__PURE__ */jsxRuntime.jsx(_internalBrowser.ValidationProvider, {
            validation,
...
function FormProvider(props) {
  ...
  const {
    file,
    image
  } = _internalBrowser.useSource().form;
  const Input = _internalBrowser.useInputComponent();
  const Field = _internalBrowser.useFieldComponent();
  const Preview = _internalBrowser.usePreviewComponent();
  const Item = _internalBrowser.useItemComponent();
  const Block = _internalBrowser.useBlockComponent();
  const InlineBlock = _internalBrowser.useInlineBlockComponent();
  const Annotation = _internalBrowser.useAnnotationComponent();
  ...
  const renderPreview = React.useCallback(previewProps => /* @__PURE__ */jsxRuntime.jsx(_internalBrowser.PreviewLoader, {
    component: Preview,
    ...previewProps
  }), [Preview]);
...
function FormBuilder(props) {
  ...
  const handleBlur = React.useCallback(() => onPathBlur(_internalBrowser.EMPTY_ARRAY), [onPathBlur]);
  const handleFocus = React.useCallback(() => onPathFocus(_internalBrowser.EMPTY_ARRAY), [onPathFocus]);
  const handleChange = React.useCallback(patch => onChange(_internalBrowser.PatchEvent.from(patch)), [onChange]);
  const focusRef = React.useRef(null);
  const handleSelectFieldGroup = React.useCallback(groupName => onFieldGroupSelect(_internalBrowser.EMPTY_ARRAY, groupName), [onFieldGroupSelect]);
  ...
  return /* @__PURE__ */jsxRuntime.jsx(FormProvider, {
    ...
    readOnly,
    schemaType,
    children: /* @__PURE__ */jsxRuntime.jsx(_internalBrowser.GetFormValueProvider, {
      value,
      children: /* @__PURE__ */jsxRuntime.jsx(_internalBrowser.FormValueProvider, {
        value,
        children: /* @__PURE__ */jsxRuntime.jsx(_internalBrowser.DocumentFieldActionsProvider, {
          actions: fieldActions,
...
function PresenceScope(props) {
  ...
  const contextPresence = React__default.default.useContext(_internalBrowser.FormFieldPresenceContext);
  ...
  return /* @__PURE__ */jsxRuntime.jsx(_internalBrowser.FormFieldPresenceContext.Provider, {
    value: childPresence,
    children
  });
}
function ArrayOfObjectsInputMember(props) {
  ...
  if (member.kind === "item") {
    return /* @__PURE__ */jsxRuntime.jsx(_internalBrowser.ArrayOfObjectsItem, {
      member,
      renderAnnotation,
      renderBlock,
      renderField,
  ...
  if (member.kind === "error") {
    return /* @__PURE__ */jsxRuntime.jsx(_internalBrowser.MemberItemError, {
      member
    }, member.key);
  }
...
const defaultRenderAnnotation = props => {
  return React.createElement(_internalBrowser.defaultResolveAnnotationComponent(props.schemaType), props);
};
const defaultRenderBlock = props => {
  return React.createElement(_internalBrowser.defaultResolveBlockComponent(props.schemaType), props);
};
const defaultRenderInlineBlock = props => {
  return React.createElement(_internalBrowser.defaultResolveInlineBlockComponent(props.schemaType), props);
};
const defaultRenderField = props => {
  return React.createElement(_internalBrowser.defaultResolveFieldComponent(props.schemaType), props);
};
const defaultRenderInput = props => {
  return React.createElement(_internalBrowser.defaultResolveInputComponent(props.schemaType), props);
};
const defaultRenderItem = props => {
  return React.createElement(_internalBrowser.defaultResolveItemComponent(props.schemaType), props);
};
const defaultRenderPreview = props => {
  return React.createElement(_internalBrowser.Preview, props);
};
const remoteSnapshots = _internalBrowser.memoize((client, idPair, typeName) => {
  return _internalBrowser.memoizedPair(client, idPair, typeName).pipe(operators.switchMap(_ref16 => {
    let {
      published,
      draft
    } = _ref16;
...
function useDocumentType(documentId) {
  ...
  const documentStore = _internalBrowser.useDocumentStore();
  const publishedId = _internalBrowser.getPublishedId(documentId);
...
function useTimelineStore(_ref17) {
  let {
    documentId,
    documentType,
    onError,
  ...
  const historyStore = _internalBrowser.useHistoryStore();
  const snapshotsSubscriptionRef = React.useRef(null);
  const timelineStateRef = React.useRef(INITIAL_TIMELINE_STATE);
  const client = _internalBrowser.useClient(_internalBrowser.DEFAULT_STUDIO_CLIENT_OPTIONS);
...
function useProject() {
  const projectStore = _internalBrowser.useProjectStore();
...
function resolveConfig(config) {
  const {
    workspaces
  } = _internalBrowser.prepareConfig(config);
  return rxjs.combineLatest(
  // eslint-disable-next-line @typescript-eslint/no-unused-vars
  workspaces.flatMap(workspaceSummary => rxjs.combineLatest(workspaceSummary.__internal.sources.map(_ref18 => {
    let {
      source
    } = _ref18;
    return source;
...
function Studio(props) {
  ...
  return /* @__PURE__ */jsxRuntime.jsxs(_internalBrowser.StudioProvider, {
    basePath,
    config,
    onSchemeChange,
    scheme,
    unstable_history,
    unstable_noAuthBoundary,
    children: [globalStyles && /* @__PURE__ */jsxRuntime.jsx(_internalBrowser.GlobalStyle, {}), /* @__PURE__ */jsxRuntime.jsx(_internalBrowser.StudioLayout, {})]
  });
}
...
function WithReferringDocuments(_ref28) {
  let {
    children,
    id
  } = _ref28;
...
function ZIndexProvider(_ref29) {
  let {
    children
  } = _ref29;
  return /* @__PURE__ */jsxRuntime.jsx(_internalBrowser.ZIndexContext.Provider, {
    value: _internalBrowser.defaults,
    children
  });
}
...
function RelativeTime(_ref30) {
  ...
  const timeAgo = _internalBrowser.useRelativeTime(timestamp, options);
...
function getObjectFieldsetAndFieldGroupOperations(node, path) {
  ...
  if (fieldMember && hasAllMembers(fieldMember.field)) {
    if (_internalBrowser.isMemberArrayOfObjects(fieldMember)) {
      ops.push(...getArrayFieldsetAndFieldGroupOperations(fieldMember.field, tail));
    } else if (_internalBrowser.isMemberObject(fieldMember)) {
...
function isAcceptedObjectValue(value) {
  return typeof value === "undefined" || _internalBrowser.isRecord(value);
}
...
function prepareFieldMember(props) {
  ...
  const fieldLevel = _internalBrowser.getFieldLevel(field.type, parent.level + 1);
  ...
  if (types.isObjectSchemaType(field.type)) {
    ...
    const fieldComparisonValue = _internalBrowser.isRecord(parentComparisonValue) ? parentComparisonValue == null ? void 0 : parentComparisonValue[field.name] : void 0;
...
function prepareObjectInputState(props) {
  ...
  const presence = filteredPresence.length ? filteredPresence : _internalBrowser.EMPTY_ARRAY;
...
function useFormState(schemaType, _ref31) {
  let {
    comparisonValue,
    value,
    fieldGroupState,
  ...
  const currentUser = _internalBrowser.useCurrentUser();
  ...
  return React.useMemo(() => {
    ...
    const reconciled = _internalBrowser.immutableReconcile(prev.current, next);
...
function toMutationPatch(patch) {
  ...
  } else if (patch.patchType !== _internalBrowser.SANITY_PATCH_TYPE) {
...
exports.ChangeIndicatorContext = _internalBrowser.ChangeIndicatorContext;
...
exports.createSearchQuery = _internalBrowser.createSearchQuery;
exports.createSettingsStore = _internalBrowser.createSettingsStore;
...
exports.useCurrentLocale = _internalBrowser.useCurrentLocale;
...
exports.useLocale = _internalBrowser.useLocale;
...
exports.useSettingsStore = _internalBrowser.useSettingsStore;
