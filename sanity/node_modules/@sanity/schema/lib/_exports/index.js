...
var resolve = require('../_chunks/resolve-N-dzXyVZ.js');
...
var flatMap__default = /*#__PURE__*/_interopDefaultCompat(flatMap);
...
var toPath__default = /*#__PURE__*/_interopDefaultCompat(toPath);
...
const AnyType = {
  ...
  extend(subTypeDef, extendMember) {
    const parsed = Object.assign(pick__default.default(ANY_CORE, OVERRIDABLE_FIELDS$e), subTypeDef, {
      type: ANY_CORE,
    ...
    function subtype(parent) {
      return {
        ...
        extend: extensionDef => {
          ...
          const current = Object.assign({}, parent, pick__default.default(extensionDef, OVERRIDABLE_FIELDS$e), {
            type: parent
          });
...
const StringType = {
  ...
  extend(subTypeDef) {
    const parsed = Object.assign(pick__default.default(STRING_CORE, OVERRIDABLE_FIELDS$d), subTypeDef, {
      type: STRING_CORE,
    ...
    function subtype(parent) {
      return {
        ...
        extend: extensionDef => {
          const current = Object.assign({}, parent, pick__default.default(extensionDef, OVERRIDABLE_FIELDS$d), {
            type: parent
          });
          return subtype(current);
        }
...
const TextType = {
  ...
  extend(subTypeDef) {
    const parsed = Object.assign(pick__default.default(TEXT_CORE, OVERRIDABLE_FIELDS$c), subTypeDef, {
      type: TEXT_CORE,
      preview: primitivePreview
    });
    return subtype(parsed);
    function subtype(parent) {
      return {
        ...
        extend: extensionDef => {
          const current = Object.assign({}, parent, pick__default.default(extensionDef, OVERRIDABLE_FIELDS$c), {
            type: parent
          });
          return subtype(current);
        }
...
const DateTimeType = {
  ...
  extend(subTypeDef) {
    const parsed = Object.assign(pick__default.default(DATETIME_CORE, OVERRIDABLE_FIELDS$b), subTypeDef, {
      type: DATETIME_CORE,
      preview: primitivePreview
    });
    return subtype(parsed);
    function subtype(parent) {
      return {
        ...
        extend: extensionDef => {
          const current = Object.assign({}, parent, pick__default.default(extensionDef, OVERRIDABLE_FIELDS$b), {
            type: parent
          });
          return subtype(current);
        }
...
const DateType = {
  ...
  extend(subTypeDef) {
    const parsed = Object.assign(pick__default.default(DATE_CORE, OVERRIDABLE_FIELDS$a), subTypeDef, {
      type: DATE_CORE,
      preview: primitivePreview
    });
    return subtype(parsed);
    function subtype(parent) {
      return {
        ...
        extend: extensionDef => {
          const current = Object.assign({}, parent, pick__default.default(extensionDef, OVERRIDABLE_FIELDS$a), {
            type: parent
          });
          return subtype(current);
        }
...
const BooleanType = {
  ...
  extend(subTypeDef) {
    const parsed = Object.assign(pick__default.default(BOOLEAN_CORE, OVERRIDABLE_FIELDS$9), subTypeDef, {
      type: BOOLEAN_CORE,
      preview: primitivePreview
    });
    return subtype(parsed);
...
const UrlType = {
  ...
  extend(subTypeDef) {
    const parsed = Object.assign(pick__default.default(URL_CORE, OVERRIDABLE_FIELDS$8), subTypeDef, {
      type: URL_CORE,
      preview: primitivePreview
    });
    return subtype(parsed);
    function subtype(parent) {
      return {
        ...
        extend: extensionDef => {
          const current = Object.assign({}, parent, pick__default.default(extensionDef, OVERRIDABLE_FIELDS$8), {
            type: parent
          });
          return subtype(current);
        }
...
const EmailType = {
  ...
  extend(subTypeDef) {
    const parsed = Object.assign(pick__default.default(EMAIL_CORE, OVERRIDABLE_FIELDS$7), subTypeDef, {
      type: EMAIL_CORE,
      preview: primitivePreview
    });
    return subtype(parsed);
    function subtype(parent) {
      return {
        ...
        extend: extensionDef => {
          const current = Object.assign({}, parent, pick__default.default(extensionDef, OVERRIDABLE_FIELDS$7), {
            type: parent
          });
          return subtype(current);
        }
...
const NumberType = {
  ...
  extend(subTypeDef) {
    const parsed = Object.assign(pick__default.default(NUMBER_CORE, OVERRIDABLE_FIELDS$6), subTypeDef, {
      type: NUMBER_CORE,
      preview: primitivePreview
    });
    return subtype(parsed);
    function subtype(parent) {
      return {
        ...
        extend: extensionDef => {
          const current = Object.assign({}, parent, pick__default.default(extensionDef, OVERRIDABLE_FIELDS$6), {
            type: parent
          });
          return subtype(current);
        }
...
function guessPreviewFields(rawObjectTypeDef) {
  ...
  const select = omitBy__default.default({
    title: titleField,
...
const ObjectType = {
  ...
  extend(rawSubTypeDef, createMemberType) {
    ...
    const parsed = Object.assign(pick__default.default(this.get(), OVERRIDABLE_FIELDS$5), subTypeDef, {
      type: this.get(),
      title: subTypeDef.title || (subTypeDef.name ? startCase__default.default(subTypeDef.name) : ""),
      options,
    ...
    lazyGetter(parsed, "__experimental_search", () => {
      ...
      return resolve.resolveSearchConfig(parsed);
    }, {
      enumerable: false
    });
    return subtype(parsed);
    function subtype(parent) {
      return {
        ...
        extend: extensionDef => {
          ...
          const current = Object.assign({}, parent, pick__default.default(extensionDef, OVERRIDABLE_FIELDS$5), {
            title: extensionDef.title || subTypeDef.title || (subTypeDef.name ? startCase__default.default(subTypeDef.name) : ""),
            type: parent
          });
...
function createFieldsets(typeDef, fields) {
  ...
  for (const fieldset of typeDef.fieldsets || []) {
    if (fieldsetsByName[fieldset.name]) {
      throw new Error('Duplicate fieldset name "'.concat(fieldset.name, "\" found for type '").concat(typeDef.title ? typeDef.title : startCase__default.default(typeDef.name), "'"));
    }
    fieldsetsByName[fieldset.name] = {
      title: startCase__default.default(fieldset.name),
      ...fieldset,
      fields: []
    };
  }
...
function createFieldsGroups(typeDef, fields) {
  ...
  for (const group of typeDef.groups || []) {
    if (groupsByName[group.name]) {
      throw new Error('Duplicate group name "'.concat(group.name, "\" found for type '").concat(typeDef.title ? typeDef.title : startCase__default.default(typeDef.name), "'"));
    }
    groupsByName[group.name] = {
      title: startCase__default.default(group.name),
      ...group,
      fields: []
    };
    if (group.default && ++numDefaultGroups > 1) {
      throw new Error("More than one field group defined as default for type '".concat(typeDef.title ? typeDef.title : startCase__default.default(typeDef.name), "' - only 1 is supported"));
    }
  }
  fields.forEach(field => {
    ...
    fieldGroupNames.forEach(fieldGroupName => {
      ...
      if (!currentGroup) {
        throw new Error("Field group '".concat(fieldGroupName, "' is not defined in schema for type '").concat(typeDef.title ? typeDef.name : startCase__default.default(typeDef.name), "'"));
      }
      currentGroup.fields.push(field);
    });
  });
  return flatMap__default.default(groupsByName).filter(group => group.fields.length > 0);
}
const REF_FIELD$1 = {
  name: "_ref",
...
function buildTitle$1(type) {
  ...
  return "Reference to ".concat(humanize$1(arrify__default.default(type.to).map(toType => toType.title), "or").toLowerCase());
}
const ReferenceType = {
  get() {
  ...
  extend(subTypeDef, createMemberType) {
    ...
    const parsed = Object.assign(pick__default.default(REFERENCE_CORE, OVERRIDABLE_FIELDS$4), subTypeDef, {
      type: REFERENCE_CORE
    });
    ...
    function subtype(parent) {
      return {
        ...
        extend: extensionDef => {
          ...
          const current = Object.assign({}, parent, pick__default.default(extensionDef, OVERRIDABLE_FIELDS$4), {
            type: parent
          });
          return subtype(current);
        }
...
function buildTitle(type) {
  ...
  return "Cross dataset reference to ".concat(humanize(arrify__default.default(type.to).map(toType => toType.title || capitalize__default.default(toType.type)), "or").toLowerCase());
}
const CrossDatasetReferenceType = {
  ...
  extend(subTypeDef, createMemberType) {
    ...
    const parsed = Object.assign(pick__default.default(CROSS_DATASET_REFERENCE_CORE, OVERRIDABLE_FIELDS$3), subTypeDef, {
    ...
    function subtype(parent) {
      return {
        ...
        extend: extensionDef => {
          ...
          const current = Object.assign({}, parent, pick__default.default(extensionDef, OVERRIDABLE_FIELDS$3), {
            type: parent
          });
          return subtype(current);
        }
...
const ImageType = {
  ...
  extend(rawSubTypeDef, createMemberType) {
    ...
    const parsed = Object.assign(pick__default.default(this.get(), OVERRIDABLE_FIELDS$2), subTypeDef, {
      type: IMAGE_CORE,
      title: subTypeDef.title || (subTypeDef.name ? startCase__default.default(subTypeDef.name) : ""),
      options,
      fields: subTypeDef.fields.map(fieldDef => {
    ...
    function subtype(parent) {
      return {
        ...
        extend: extensionDef => {
          ...
          const current = Object.assign({}, parent, pick__default.default(extensionDef, OVERRIDABLE_FIELDS$2), {
            type: parent
          });
          return subtype(current);
        }
...
const FileType = {
  ...
  extend(rawSubTypeDef, createMemberType) {
    ...
    const parsed = Object.assign(pick__default.default(FILE_CORE, OVERRIDABLE_FIELDS$1), subTypeDef, {
      type: FILE_CORE,
      title: subTypeDef.title || (subTypeDef.name ? startCase__default.default(subTypeDef.name) : ""),
      options,
      fields: subTypeDef.fields.map(fieldDef => {
    ...
    function subtype(parent) {
      return {
        ...
        extend: extensionDef => {
          ...
          const current = Object.assign({}, parent, pick__default.default(extensionDef, OVERRIDABLE_FIELDS$1), {
            type: parent
          });
          return subtype(current);
        }
...
const ArrayType = {
  ...
  extend(subTypeDef, createMemberType) {
    const parsed = Object.assign(pick__default.default(ARRAY_CORE, OVERRIDABLE_FIELDS), subTypeDef, {
      type: ARRAY_CORE
    });
    ...
    function subtype(parent) {
      return {
        ...
        extend: extensionDef => {
          ...
          const current = Object.assign({}, parent, pick__default.default(extensionDef, OVERRIDABLE_FIELDS), {
            type: parent
          });
          return subtype(current);
        }
...
const BlockType = {
  ...
  extend(subTypeDef, extendMember) {
    ...
    const parsed = Object.assign(pick__default.default(BLOCK_CORE, INHERITED_FIELDS$1), rest, {
      type: BLOCK_CORE,
      options
    });
    lazyGetter(parsed, "fields", () => {
    ...
    function subtype(parent) {
      return {
        ...
        extend: extensionDef => {
          ...
          const current = Object.assign({}, parent, pick__default.default(extensionDef, INHERITED_FIELDS$1), {
            type: parent
          });
          return subtype(current);
        }
...
const SpanType = {
  ...
  extend(subTypeDef, extendMember) {
    ...
    const parsed = Object.assign(pick__default.default(SPAN_CORE, INHERITED_FIELDS), subTypeDef, {
      type: SPAN_CORE,
      options
    });
    lazyGetter(parsed, "fields", () => {
    ...
    function subtype(parent) {
      return {
        ...
        extend: extensionDef => {
          ...
          const current = Object.assign({}, parent, pick__default.default(extensionDef, INHERITED_FIELDS), {
            type: parent
          });
          return subtype(current);
        }
