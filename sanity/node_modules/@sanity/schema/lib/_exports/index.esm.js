...
import { resolveSearchConfig, resolveSearchConfigForBaseFieldPaths } from '../_chunks/resolve-67bA2d6j.js';
...
const ImageType = {
  ...
  extend(rawSubTypeDef, createMemberType) {
    ...
    const parsed = Object.assign(pick(this.get(), OVERRIDABLE_FIELDS$2), subTypeDef, {
      type: IMAGE_CORE,
      title: subTypeDef.title || (subTypeDef.name ? startCase(subTypeDef.name) : ""),
      options,
      fields: subTypeDef.fields.map(fieldDef => {
