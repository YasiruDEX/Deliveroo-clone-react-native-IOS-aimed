...
export declare const PortableTextEditable: React_2.ForwardRefExoticComponent<
  Omit<
    Omit<React_2.TextareaHTMLAttributes<HTMLDivElement>, 'onCopy' | 'onPaste' | 'onBeforeInput'> & {
...
export declare type PortableTextEditableProps = Omit<
  React_2.TextareaHTMLAttributes<HTMLDivElement>,
 ...
 * @public
 */
export declare class PortableTextEditor extends React_2.Component<PortableTextEditorProps> {
  /**
