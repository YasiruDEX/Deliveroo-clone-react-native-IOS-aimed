...
var SplitPane = require('@rexxars/react-split-pane');
...
var index = require('./index-wuKsDqFP.js');
var HLRU = require('hashlru');
var JSONInspector = require('@rexxars/react-json-inspector');
...
var SplitPane__default = /*#__PURE__*/_interopDefaultCompat(SplitPane);
...
var HLRU__default = /*#__PURE__*/_interopDefaultCompat(HLRU);
var JSONInspector__default = /*#__PURE__*/_interopDefaultCompat(JSONInspector);
...
function DelayedSpinner(props) {
  ...
  return show ? /* @__PURE__ */jsxRuntime.jsx(ui.Spinner, {
    muted: true,
    size: 4
  }) : null;
}
const codemirrorExtensions = [[langJavascript.javascriptLanguage], view.lineNumbers(), view.highlightActiveLine(), view.highlightActiveLineGutter(), search.highlightSelectionMatches(), view.highlightSpecialChars(), language.indentOnInput(), language.bracketMatching(), autocomplete.closeBrackets(), commands.history(), view.drawSelection(), language.syntaxHighlighting(language.defaultHighlightStyle, {
  fallback: true
}), view.keymap.of([commands.defaultKeymap, commands.historyKeymap].flat().filter(Boolean))];
function useCodemirrorTheme(theme) {
  const cmTheme = React.useMemo(() => createTheme(theme), [theme]);
  const cmHighlight = React.useMemo(() => language.syntaxHighlighting(createHighlight(theme)), [theme]);
...
function createTheme(theme) {
  ...
  const card = color$1.card.enabled;
  const cursor = color.hues.blue[color$1.dark ? 400 : 500].hex;
  const selection = color.hues.gray[theme.sanity.color.dark ? 900 : 100].hex;
...
var _a$4;
const EditorRoot = styled__default.default.div(_a$4 || (_a$4 = __template$4(["\n  width: 100%;\n  box-sizing: border-box;\n  height: 100%;\n  overflow: hidden;\n  overflow: clip;\n  position: relative;\n  display: flex;\n\n  & .cm-theme {\n    width: 100%;\n  }\n\n  & .cm-editor {\n    height: 100%;\n\n    font-size: 16px;\n    line-height: 21px;\n  }\n\n  & .cm-line {\n    padding-left: ", ";\n  }\n\n  & .cm-content {\n    border-right-width: ", " !important;\n    padding-top: ", ";\n  }\n"])), _ref => {
  let {
    theme
  } = _ref;
  return ui.rem(theme.sanity.space[3]);
}, _ref2 => {
  let {
    theme
  } = _ref2;
  return ui.rem(theme.sanity.space[4]);
}, _ref3 => {
  let {
    theme
  } = _ref3;
  return ui.rem(theme.sanity.space[5]);
});
function VisionCodeMirror(props) {
  const sanityTheme = ui.useTheme();
  const theme = useCodemirrorTheme(sanityTheme);
  return /* @__PURE__ */jsxRuntime.jsx(EditorRoot, {
    children: /* @__PURE__ */jsxRuntime.jsx(CodeMirror__default.default, {
      basicSetup: false,
      theme,
...
function tryParseParams(val, t) {
  try {
    ...
    err.message = "".concat(t("params.error.params-invalid-json"), ":\n\n").concat(err.message.replace("JSON5:", ""));
    return err;
  }
}
...
const RO = typeof document === "undefined" ? resizeObserver.ResizeObserver : window.ResizeObserver;
const defaultValue = "{\n  \n}";
function ParamsEditor(props) {
  ...
  const handleChangeRaw = React.useCallback(newValue => {
    const event = eventFromValue(newValue, t);
    setValid(event.valid);
    onChange(event);
  }, [onChange, t]);
  const handleChange = React.useMemo(() => debounce__default.default(handleChangeRaw, 333), [handleChangeRaw]);
  return /* @__PURE__ */jsxRuntime.jsx(VisionCodeMirror, {
...
var _a$3;
const ResultViewWrapper = styled__default.default.div(_ref4 => {
  let {
    theme
  } = _ref4;
  const {
  ...
  return styled.css(_a$3 || (_a$3 = __template$3(["\n    & .json-inspector,\n    & .json-inspector .json-inspector__selection {\n      font-family: ", ";\n      font-size: ", "px;\n      line-height: ", "px;\n      color: var(--card-code-fg-color);\n    }\n\n    & .json-inspector .json-inspector__leaf {\n      padding-left: ", ";\n    }\n\n    & .json-inspector .json-inspector__leaf.json-inspector__leaf_root {\n      padding-top: ", ";\n      padding-left: 0;\n    }\n\n    & .json-inspector > .json-inspector__leaf_root > .json-inspector__line > .json-inspector__key {\n      display: none;\n    }\n\n    & .json-inspector .json-inspector__line {\n      display: block;\n      position: relative;\n      cursor: default;\n    }\n\n    & .json-inspector .json-inspector__line::after {\n      content: '';\n      position: absolute;\n      top: 0;\n      left: -200px;\n      right: -50px;\n      bottom: 0;\n      z-index: -1;\n      pointer-events: none;\n    }\n\n    & .json-inspector .json-inspector__line:hover::after {\n      background: var(--card-code-bg-color);\n    }\n\n    & .json-inspector .json-inspector__leaf_composite > .json-inspector__line {\n      cursor: pointer;\n    }\n\n    & .json-inspector .json-inspector__leaf_composite > .json-inspector__line::before {\n      content: '\u25B8 ';\n      margin-left: calc(0px - ", ");\n      font-size: ", "px;\n      line-height: ", "px;\n    }\n\n    &\n      .json-inspector\n      .json-inspector__leaf_expanded.json-inspector__leaf_composite\n      > .json-inspector__line::before {\n      content: '\u25BE ';\n      font-size: ", "px;\n      line-height: ", "px;\n    }\n\n    & .json-inspector .json-inspector__radio,\n    & .json-inspector .json-inspector__flatpath {\n      display: none;\n    }\n\n    & .json-inspector .json-inspector__value {\n      margin-left: ", ";\n    }\n\n    &\n      .json-inspector\n      > .json-inspector__leaf_root\n      > .json-inspector__line\n      > .json-inspector__key\n      + .json-inspector__value {\n      margin: 0;\n    }\n\n    & .json-inspector .json-inspector__key {\n      color: ", ";\n    }\n\n    & .json-inspector .json-inspector__value_helper,\n    & .json-inspector .json-inspector__value_null {\n      color: ", ";\n    }\n\n    & .json-inspector .json-inspector__not-found {\n      padding-top: ", ";\n    }\n\n    & .json-inspector .json-inspector__value_string {\n      color: ", ";\n      word-break: break-word;\n    }\n\n    & .json-inspector .json-inspector__value_boolean {\n      color: ", ";\n    }\n\n    & .json-inspector .json-inspector__value_number {\n      color: ", ";\n    }\n\n    & .json-inspector .json-inspector__show-original {\n      display: inline-block;\n      padding: 0 6px;\n      cursor: pointer;\n    }\n\n    & .json-inspector .json-inspector__show-original:hover {\n      color: inherit;\n    }\n\n    & .json-inspector .json-inspector__show-original::before {\n      content: '\u2194';\n    }\n\n    & .json-inspector .json-inspector__show-original:hover::after {\n      content: ' expand';\n    }\n  "])), fonts.code.family, fonts.code.sizes[2].fontSize, fonts.code.sizes[2].lineHeight, ui.rem(space[4]), ui.rem(space[0]), ui.rem(space[4]), fonts.code.sizes[2].fontSize, fonts.code.sizes[2].lineHeight, fonts.code.sizes[2].fontSize, fonts.code.sizes[2].lineHeight, ui.rem(space[4] / 2), color.syntax.property, color.syntax.constant, ui.rem(space[2]), color.syntax.string, color.syntax.boolean, color.syntax.number);
});
const lru = HLRU__default.default(5e4);
function ResultView(props) {
  const {
    data
  } = props;
  if (isRecord(data) || Array.isArray(data)) {
    return /* @__PURE__ */jsxRuntime.jsx(ResultViewWrapper, {
      children: /* @__PURE__ */jsxRuntime.jsx(JSONInspector__default.default, {
        data,
        search: false,
        isExpanded,
  ...
  return /* @__PURE__ */jsxRuntime.jsx(ui.Code, {
    language: "json",
...
var _a$2;
const ErrorCode = styled__default.default(ui.Code)(_a$2 || (_a$2 = __template$2(["\n  color: ", ";\n"])), _ref5 => {
  let {
    theme
  } = _ref5;
...
function QueryErrorDetails(_ref6) {
  ...
  return /* @__PURE__ */jsxRuntime.jsxs("div", {
    children: [/* @__PURE__ */jsxRuntime.jsx(ErrorCode, {
      size: 1,
      ...
      children: /* @__PURE__ */jsxRuntime.jsx(ErrorCode, {
        size: 1,
        children: "".concat(t("query.error.line"), ":   ").concat(details.lineNumber, "\n").concat(t("query.error.column"), ": ").concat(details.column)
      })
    })]
  });
}
...
function QueryErrorDialog(props) {
  return /* @__PURE__ */jsxRuntime.jsxs(ui.Stack, {
    ...
    }), /* @__PURE__ */jsxRuntime.jsx(QueryErrorDetails, {
      error: props.error
    })]
  });
}
...
var _a$1, _b$1;
const PerspectivePopoverContent = styled__default.default(ui.Box)(_a$1 || (_a$1 = __template$1(["\n  /* This limits the width of the popover content */\n  max-width: 240px;\n"])));
const PerspectivePopoverLink = styled__default.default.a(_b$1 || (_b$1 = __template$1(["\n  cursor: pointer;\n  margin-right: auto;\n"])));
function PerspectivePopover() {
  ...
  ui.useClickOutside(handleClickOutside, [buttonEl, popoverEl]);
  return /* @__PURE__ */jsxRuntime.jsx(ui.Popover, {
    content: /* @__PURE__ */jsxRuntime.jsx(PerspectivePopoverContent, {
      children: /* @__PURE__ */jsxRuntime.jsxs(ui.Stack, {
        ...
        children: [/* @__PURE__ */jsxRuntime.jsxs(ui.Inline, {
          ...
          children: [/* @__PURE__ */jsxRuntime.jsx(ui.Text, {
            weight: "medium",
            children: t("settings.perspectives.title")
          }), /* @__PURE__ */jsxRuntime.jsx(ui.Badge, {
            tone: "primary",
            children: t("label.new")
          })]
        }), /* @__PURE__ */jsxRuntime.jsx(ui.Card, {
          children: /* @__PURE__ */jsxRuntime.jsx(ui.Text, {
            muted: true,
            children: t("settings.perspectives.description")
          })
        }), /* @__PURE__ */jsxRuntime.jsx(ui.Card, {
          children: /* @__PURE__ */jsxRuntime.jsx(ui.Text, {
            children: /* @__PURE__ */jsxRuntime.jsxs(PerspectivePopoverLink, {
              href: "https://sanity.io/docs/perspectives",
              target: "_blank",
              children: [t("settings.perspectives.action.docs-link"), " \u2192"]
            })
          })
        })]
      })
...
const Root = styled__default.default(ui.Flex)(_a || (_a = __template(["\n  .sidebarPanes .Pane {\n    overflow-y: auto;\n    overflow-x: hidden;\n  }\n\n  & .Resizer {\n    background: var(--card-border-color);\n    opacity: 1;\n    z-index: 1;\n    box-sizing: border-box;\n    background-clip: padding-box;\n    border: solid transparent;\n  }\n\n  & .Resizer:hover {\n    border-color: var(--card-shadow-ambient-color);\n  }\n\n  & .Resizer.horizontal {\n    height: 11px;\n    margin: -5px 0;\n    border-width: 5px 0;\n    cursor: row-resize;\n    width: 100%;\n    z-index: 4;\n  }\n\n  & .Resizer.vertical {\n    width: 11px;\n    margin: 0 -5px;\n    border-width: 0 5px;\n    cursor: col-resize;\n    z-index: 2; /* To prevent the resizer from being hidden behind CodeMirror scroll area */\n  }\n\n  .Resizer.disabled {\n    cursor: not-allowed;\n  }\n\n  .Resizer.disabled:hover {\n    border-color: transparent;\n  }\n"])));
Root.displayName = "Root";
const Header = styled__default.default(ui.Card)(_b || (_b = __template(["\n  border-bottom: 1px solid var(--card-border-color);\n"])));
const StyledLabel = styled__default.default(ui.Label)(_c || (_c = __template(["\n  flex: 1;\n"])));
const SplitpaneContainer = styled__default.default(ui.Box)(_d || (_d = __template(["\n  position: relative;\n"])));
const QueryCopyLink = styled__default.default.a(_e || (_e = __template(["\n  cursor: pointer;\n  margin-right: auto;\n"])));
const InputBackgroundContainer = styled__default.default(ui.Box)(_f || (_f = __template(["\n  position: absolute;\n  top: 1rem;\n  left: 0;\n  padding: 0;\n  margin: 0;\n  z-index: 10;\n  right: 0;\n\n  ", " {\n    user-select: none;\n  }\n"])), StyledLabel);
const InputBackgroundContainerLeft = styled__default.default(InputBackgroundContainer)(_g || (_g = __template(["\n  // This is so its aligned with the gutters of CodeMirror\n  left: 33px;\n"])));
const InputContainer = styled__default.default(ui.Card)(_h || (_h = __template(["\n  width: 100%;\n  height: 100%;\n  position: relative;\n  flex-direction: column;\n"])));
const ResultOuterContainer = styled__default.default(ui.Flex)(_i || (_i = __template(["\n  height: 100%;\n"])));
const ResultInnerContainer = styled__default.default(ui.Box)(_j || (_j = __template(["\n  position: relative;\n"])));
const ResultContainer = styled__default.default(ui.Card)(_l || (_l = __template(["\n  height: 100%;\n  width: 100%;\n  position: absolute;\n  max-width: 100%;\n\n  ", "\n"])), _ref7 => {
  let {
    $isInvalid
  } = _ref7;
  return $isInvalid && styled.css(_k || (_k = __template(["\n      &:after {\n        background-color: var(--card-bg-color);\n        content: '';\n        position: absolute;\n        top: 0;\n        bottom: 0;\n        left: 0;\n        width: 100%;\n      }\n    "])));
});
const Result = styled__default.default(ui.Box)(_m || (_m = __template(["\n  position: relative;\n  width: 100%;\n  height: 100%;\n  z-index: 20;\n"])));
const TimingsFooter = styled__default.default(ui.Box)(_n || (_n = __template(["\n  border-top: 1px solid var(--card-border-color);\n"])));
const TimingsCard = styled__default.default(ui.Card)(_o || (_o = __template(["\n  position: relative;\n"])));
styled__default.default(ui.Box)(_p || (_p = __template(["\n  width: 100%;\n  height: 100%;\n"])));
const TimingsTextContainer = styled__default.default(ui.Flex)(_q || (_q = __template(["\n  height: 100%;\n  min-height: ", ";\n"])), _ref8 => {
  let {
    theme
  } = _ref8;
  return ui.rem(theme.sanity.space[3] * 2 + theme.sanity.fonts.text.sizes[2].lineHeight - theme.sanity.fonts.text.sizes[2].ascenderHeight - theme.sanity.fonts.text.sizes[2].descenderHeight);
});
const ControlsContainer = styled__default.default(ui.Box)(_r || (_r = __template(["\n  border-top: 1px solid var(--card-border-color);\n"])));
...
const isRunHotkey = event => isHotkey__default.default("ctrl+enter", event) || isHotkey__default.default("mod+enter", event);
...
class VisionGui extends React__default.default.PureComponent {
  constructor(props) {
    super(props);
    const {
      client,
    ...
    this._visionRoot = React__default.default.createRef();
    this._operationUrlElement = React__default.default.createRef();
    this._queryEditorContainer = React__default.default.createRef();
    this._paramsEditorContainer = React__default.default.createRef();
    this._customApiVersionElement = React__default.default.createRef();
    ...
    const params = lastParams ? tryParseParams(lastParams, this.props.t) : void 0;
    this.state = {
      // Selected options
      dataset,
      apiVersion,
  ...
  render() {
    ...
    return /* @__PURE__ */jsxRuntime.jsxs(Root, {
          ...
          children: [/* @__PURE__ */jsxRuntime.jsx(ui.Box, {
            ...
            children: /* @__PURE__ */jsxRuntime.jsxs(ui.Stack, {
              children: [/* @__PURE__ */jsxRuntime.jsx(ui.Card, {
                ...
                children: datasets.map(ds => /* @__PURE__ */jsxRuntime.jsx("option", {
                  children: ds
                }, ds))
              })]
            })
            ...
            children: /* @__PURE__ */jsxRuntime.jsxs(ui.Stack, {
              children: [/* @__PURE__ */jsxRuntime.jsx(ui.Card, {
                ...
                children: [API_VERSIONS.map(version => /* @__PURE__ */jsxRuntime.jsx("option", {
                  children: version
                }, version)), /* @__PURE__ */jsxRuntime.jsx("option", {
                  value: "other",
                  children: t("settings.other-api-version-label")
                }, "other")]
              })]
            })
          }), customApiVersion !== false && /* @__PURE__ */jsxRuntime.jsx(ui.Box, {
            padding: 1,
            column: 2,
            children: /* @__PURE__ */jsxRuntime.jsxs(ui.Stack, {
              children: [/* @__PURE__ */jsxRuntime.jsx(ui.Card, {
              ...
              children: [/* @__PURE__ */jsxRuntime.jsx(ui.Card, {
                ...
                children: /* @__PURE__ */jsxRuntime.jsxs(ui.Inline, {
                  ...
                  children: [/* @__PURE__ */jsxRuntime.jsx(ui.Box, {
                    ...
                    children: /* @__PURE__ */jsxRuntime.jsx(PerspectivePopover, {})
                  })]
                })
              }), /* @__PURE__ */jsxRuntime.jsx(ui.Select, {
                value: perspective,
                onChange: this.handleChangePerspective,
                children: PERSPECTIVES.map(p => /* @__PURE__ */jsxRuntime.jsx("option", {
                  children: p
                }, p))
              })]
            })
          }), typeof url === "string" ? /* @__PURE__ */jsxRuntime.jsx(ui.Box, {
            padding: 1,
            flex: 1,
            ...
            children: /* @__PURE__ */jsxRuntime.jsxs(ui.Stack, {
              children: [/* @__PURE__ */jsxRuntime.jsx(ui.Card, {
                ...
                children: /* @__PURE__ */jsxRuntime.jsxs(StyledLabel, {
                  children: [t("query.url"), "\xA0", /* @__PURE__ */jsxRuntime.jsxs(QueryCopyLink, {
                    onClick: this.handleCopyUrl,
                    children: ["[", t("action.copy-url-to-clipboard"), "]"]
                  })]
                })
      ...
      }), /* @__PURE__ */jsxRuntime.jsx(SplitpaneContainer, {
        flex: "auto",
        children: /* @__PURE__ */jsxRuntime.jsxs(SplitPane__default.default, {
            ...
            children: /* @__PURE__ */jsxRuntime.jsxs(SplitPane__default.default, {
              ...
              children: [/* @__PURE__ */jsxRuntime.jsx(InputContainer, {
                ...
                children: /* @__PURE__ */jsxRuntime.jsxs(ui.Box, {
                  flex: 1,
                  children: [/* @__PURE__ */jsxRuntime.jsx(InputBackgroundContainerLeft, {
                  ...
                  }), /* @__PURE__ */jsxRuntime.jsx(VisionCodeMirror, {
                    value: this.state.query,
                    onChange: this.handleQueryChange
                  })]
                })
              }), /* @__PURE__ */jsxRuntime.jsxs(InputContainer, {
                display: "flex",
                ...
                children: [/* @__PURE__ */jsxRuntime.jsxs(ui.Card, {
                  ...
                  children: [/* @__PURE__ */jsxRuntime.jsx(InputBackgroundContainerLeft, {
                    children: /* @__PURE__ */jsxRuntime.jsxs(ui.Flex, {
                      ...
                      }), paramsError && /* @__PURE__ */jsxRuntime.jsx(ui.Tooltip, {
                        placement: "top-end",
                        portal: true,
                        content: paramsError,
                        children: /* @__PURE__ */jsxRuntime.jsx(ui.Box, {
                  ...
                  }), /* @__PURE__ */jsxRuntime.jsx(ParamsEditor, {
                    value: this.state.rawParams,
                    onChange: this.handleParamsChange
                  })]
                }), /* @__PURE__ */jsxRuntime.jsx(ControlsContainer, {
                  children: /* @__PURE__ */jsxRuntime.jsx(ui.Card, {
                    padding: 3,
                    paddingX: 3,
          ...
          }), /* @__PURE__ */jsxRuntime.jsxs(ResultOuterContainer, {
            direction: "column",
            children: [/* @__PURE__ */jsxRuntime.jsx(ResultInnerContainer, {
              flex: 1,
              children: /* @__PURE__ */jsxRuntime.jsx(ResultContainer, {
                flex: 1,
                overflow: "hidden",
                tone: error ? "critical" : "default",
                $isInvalid: Boolean(error),
                children: /* @__PURE__ */jsxRuntime.jsxs(Result, {
                  overflow: "auto",
                  children: [/* @__PURE__ */jsxRuntime.jsx(InputBackgroundContainer, {
                    children: /* @__PURE__ */jsxRuntime.jsx(ui.Box, {
                      marginLeft: 3,
                      children: /* @__PURE__ */jsxRuntime.jsx(StyledLabel, {
                        muted: true,
                    ...
                    padding: 3,
                    paddingTop: 5,
                    children: [(queryInProgress || listenInProgress && listenMutations.length === 0) && /* @__PURE__ */jsxRuntime.jsx(ui.Box, {
                      marginTop: 3,
                      children: /* @__PURE__ */jsxRuntime.jsx(DelayedSpinner, {})
                    }), error && /* @__PURE__ */jsxRuntime.jsx(QueryErrorDialog, {
                      error
                    }), hasResult && /* @__PURE__ */jsxRuntime.jsx(ResultView, {
                      data: queryResult
                    }), listenInProgress && listenMutations.length > 0 && /* @__PURE__ */jsxRuntime.jsx(ResultView, {
                      data: listenMutations
                    })]
                  })]
                })
              })
            }), /* @__PURE__ */jsxRuntime.jsx(TimingsFooter, {
              children: /* @__PURE__ */jsxRuntime.jsx(TimingsCard, {
                paddingX: 4,
                paddingY: 3,
                sizing: "border",
                children: /* @__PURE__ */jsxRuntime.jsxs(TimingsTextContainer, {
                  align: "center",
                  children: [/* @__PURE__ */jsxRuntime.jsx(ui.Box, {
                    children: /* @__PURE__ */jsxRuntime.jsxs(ui.Text, {
                      muted: true,
                      children: [t("result.execution-time-label"), ":", " ", typeof queryTime === "number" ? "".concat(queryTime, "ms") : t("result.timing-not-applicable")]
                    })
                  }), /* @__PURE__ */jsxRuntime.jsx(ui.Box, {
                    marginLeft: 4,
                    children: /* @__PURE__ */jsxRuntime.jsxs(ui.Text, {
                      muted: true,
                      children: [t("result.end-to-end-time-label"), ":", " ", typeof e2eTime === "number" ? "".concat(e2eTime, "ms") : t("result.timing-not-applicable")]
                    })
                  })]
                })
              })
...
function VisionContainer(props) {
  ...
  loadedDatasets;
  return /* @__PURE__ */jsxRuntime.jsx(VisionGui, {
    ...props,
    datasets,
    toast,
    t
...
function SanityVision(props) {
  ...
  return /* @__PURE__ */jsxRuntime.jsx(VisionContainer, {
    client,
    config
  });
}
exports.default = SanityVision;
//# sourceMappingURL=SanityVision-CzPwJrct.js.map
