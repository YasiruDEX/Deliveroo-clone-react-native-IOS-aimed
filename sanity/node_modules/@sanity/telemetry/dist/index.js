...
import { Subject, tap, map, throttle, concatMap, Observable, combineLatest, of, mergeMap, EMPTY, from, catchError, lastValueFrom } from 'rxjs';
...
function createBatchedStore(sessionId, options) {
  ...
  function submit() {
    return combineLatest([of(consume()), resolveConsent()]).pipe(mergeMap(_ref => {
